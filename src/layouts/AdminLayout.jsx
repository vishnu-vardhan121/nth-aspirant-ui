...
import { HiHome, HiBriefcase, HiUsers, HiUserGroup, HiAcademicCap, HiCog6Tooth, HiChatBubbleBottomCenterText, HiClipboardDocumentList, HiCalendarDays, HiPhoto, HiQueueList, HiLifebuoy, HiBuildingOffice2 } from 'react-icons/hi2';
    ...
    <div className="h-screen flex overflow-hidden bg-slate-100">
      <aside className="admin-sidebar w-56 shrink-0 h-full flex flex-col border-r border-slate-200 bg-white overflow-hidden">
        ...
        <nav className="p-2 flex-1 min-h-0 overflow-y-auto">
          ...
          <Link
            to="/admin/nexa-hiring-leads"
            className={navLinkClass(isActive('/admin/nexa-hiring-leads'))}
          >
