-- Allow spotlight updates even when job is hidden from normal landing jobs list.
-- This decouples hiring_spotlight from show_on_landing.
...
comment on function public.get_landing_hiring_spotlight() is
  'Anonymous: { jobs: [...] } for open spotlight roles; notices + shortlisted. Spotlight does not require show_on_landing.';
