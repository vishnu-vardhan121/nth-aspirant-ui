-- Mock limit = max *completed* mocks per period, not max bookings.
-- "Mocks this period" shows: completed / limit (e.g. 2 / 3 = 2 completed out of 3 allowed).

-- ========== 1) get_mock_usage: count only completed in period ==========
...
begin
  ...
  -- Count only completed mocks in this subscription period
...
-- ========== 2) book_mock_slot: allow booking if completed count < limit ==========
...
-- ========== 3) register_mock: allow request if completed count < limit ==========
